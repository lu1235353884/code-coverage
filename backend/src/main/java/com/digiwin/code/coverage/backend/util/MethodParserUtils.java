...
public class MethodParserUtils {
    ...
    public static List<MethodInfoResult> parseMethods(String classFile, String rootCodePath) {
        ...
        try (FileInputStream in = new FileInputStream(classFile)) {
            ...
            CompilationUnit cu = javaParser.parse(in).getResult().orElseThrow(() -> new BaseException(ResultCode.PARSE_JAVA_FILE));
...
//            }
            ...
            throw new BaseException(ResultCode.PARSE_JAVA_FILE);
        }
